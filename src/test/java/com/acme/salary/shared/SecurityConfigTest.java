...
@WebMvcTest(AuthController.class) @Import(SecurityConfig.class) @TestPropertySource(properties={"app.demo.username=hr@acme.test","app.demo.password=ChangeMe123!","app.allowed-origins=https://salary-management-web.onrender.com"})
